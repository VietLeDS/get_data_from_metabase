...
if __name__ == '__main__':
    ...
    run_meta(c.NEW_DOWNLOAD_PATH, list_run_group=['wh'], replace=False)
    schedule.every().day.at("09:00").do(run_meta, c.NEW_DOWNLOAD_PATH, list_run_group=['wh'], replace=False)
    while True:
